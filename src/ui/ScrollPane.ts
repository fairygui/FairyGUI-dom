...
export class ScrollPane {
    ...
    private __touchBegin(evt: Event): void {
        ...
        var pt: Vec2 = this._owner.globalToLocal(evt.input.x, evt.input.y, s_vec2);
    ...
    private __touchMove(evt: Event): void {
        ...
        var pt: Vec2 = this._owner.globalToLocal(evt.input.x, evt.input.y);
    ...
    private __mouseWheel(evt: Event): void {
        ...
        var delta: number = evt.input.mouseWheelDelta / 40;
